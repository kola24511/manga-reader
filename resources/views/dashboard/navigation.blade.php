<div x-data="{ tab: window.location.hash ? window.location.hash.substring(1) : 'profile' }" id="tab_wrapper">
    <nav class="border-b border-gray-960">
        <a class="px-4 py-2.5 text-xl inline-block align-middle font-medium hover:bg-gray-200 focus:text-blue-500 focus:underline focus:underline-offset-8 dark:text-gray-100 dark:hover:bg-gray-940 dark:focus:text-blue-500"
